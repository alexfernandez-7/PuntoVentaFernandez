                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            @if (($producto->imagen)!="")
                            <td><img src="http://localhost/puntoventafernandez/public/imagenes/productos/{{$producto->imagen}}" alt="{{ $producto->nombre }}" width="70px" height="70px" class="img-thumbnail"></td>
                            @endif
                        </div>
                    </div>
